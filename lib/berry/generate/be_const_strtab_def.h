...
be_define_const_str(_name_, "_name_", 4106759638u, 0, 6, &be_const_str_get);
be_define_const_str(_str, "_str", 2811624257u, 0, 4, &be_const_str_bool);
...
be_define_const_str(addfloat, "addfloat", 937731078u, 0, 8, &be_const_str_list);
...
be_define_const_str(append, "append", 110723809u, 0, 6, &be_const_str_endswith);
be_define_const_str(appendb64, "appendb64", 277140235u, 0, 9, NULL);
be_define_const_str(appendhex, "appendhex", 3568017334u, 0, 9, &be_const_str_copy);
be_define_const_str(as, "as", 1579491469u, 69, 2, &be_const_str_item);
...
be_define_const_str(break, "break", 3378807160u, 60, 5, &be_const_str_class);
...
be_define_const_str(char, "char", 2823553821u, 0, 4, &be_const_str_real);
be_define_const_str(class, "class", 2872970239u, 59, 5, NULL);
...
be_define_const_str(continue, "continue", 2977070660u, 61, 8, &be_const_str_issubclass);
...
be_define_const_str(def, "def", 3310976652u, 57, 3, &be_const_str_imax);
be_define_const_str(deg, "deg", 3327754271u, 0, 3, &be_const_str_do);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, &be_const_str_inf);
be_define_const_str(do, "do", 1646057492u, 67, 2, &be_const_str_frees);
be_define_const_str(dump, "dump", 3663001223u, 0, 4, &be_const_str_max);
be_define_const_str(elif, "elif", 3232090307u, 53, 4, &be_const_str_escape);
be_define_const_str(else, "else", 3183434736u, 54, 4, &be_const_str_floor);
be_define_const_str(end, "end", 1787721130u, 58, 3, &be_const_str_log10);
be_define_const_str(endswith, "endswith", 790464931u, 0, 8, &be_const_str_varname);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_min);
be_define_const_str(except, "except", 950914032u, 71, 6, &be_const_str_log);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_if);
be_define_const_str(false, "false", 184981848u, 64, 5, NULL);
...
be_define_const_str(for, "for", 2901640080u, 56, 3, &be_const_str_ismapped);
...
be_define_const_str(hex, "hex", 4273249610u, 0, 3, &be_const_str_startswith);
be_define_const_str(if, "if", 959999494u, 52, 2, NULL);
be_define_const_str(imax, "imax", 3084515410u, 0, 4, NULL);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, NULL);
be_define_const_str(import, "import", 288002260u, 68, 6, &be_const_str_sqrt);
be_define_const_str(incr, "incr", 482404207u, 0, 4, &be_const_str_round);
be_define_const_str(inf, "inf", 2749994088u, 0, 3, &be_const_str_sinh);
be_define_const_str(init, "init", 380752755u, 0, 4, &be_const_str_resize);
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_isreadonly);
...
be_define_const_str(isreadonly, "isreadonly", 1768869895u, 0, 10, &be_const_str_tohex);
...
be_define_const_str(max, "max", 3617776409u, 0, 3, &be_const_str_module);
...
be_define_const_str(min, "min", 3381609815u, 0, 3, &be_const_str_tob64);
...
be_define_const_str(nil, "nil", 228849900u, 65, 3, &be_const_str_pop);
...
be_define_const_str(raise, "raise", 1593437475u, 72, 5, NULL);
...
be_define_const_str(round, "round", 1326178875u, 0, 5, &be_const_str_setrange);
...
be_define_const_str(startswith, "startswith", 4221853948u, 0, 10, &be_const_str_static);
...
be_define_const_str(try, "try", 2887626766u, 70, 3, NULL);
...
static const bstring* const m_string_table[] = {
    ...
    (const bstring *)&be_const_str_undef,
    NULL,
